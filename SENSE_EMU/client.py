...
db_client = repo.DbClient("SENSE_EMU/data/readings.db") #napravili smo clienta kojem smo iz modula repo klasu DbClient koja ima bazu podataka koji nam trebaju
